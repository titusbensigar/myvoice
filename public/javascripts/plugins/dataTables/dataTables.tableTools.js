...
TableTools.BUTTONS = {
	...
	"xls": $.extend( {}, TableTools.buttonBase, {
		...
		"sCharSet": "utf16le",
		"bBomInc": true,
		"sToolTip": "Download XLS",
		"sButtonClass": "btn btn-info",
		"sButtonText": "<i class='fa fa-table'></i> XLS",
		"fnClick": function( nButton, oConfig, flash ) {
			this.fnSetText( flash, this.fnGetTableData(oConfig) );
		}
	} ),
	...
	"pdf": $.extend( {}, TableTools.buttonBase, {
		...
		"sFileName": "*.pdf",
		"sButtonClass": "btn btn-info",
		"sButtonText": "<i class='fa fa-file'></i> PDF",
		"sPdfOrientation": "portrait",
		"sPdfSize": "A4",
		"sToolTip": "Download PDF",
		"sPdfMessage": "",
		"fnClick": function( nButton, oConfig, flash ) {
	...
	"collection": $.extend( {}, TableTools.buttonBase, {
		"sAction": "collection",
		"sButtonClass": "btn btn-info btn-outline",
		"sToolTip": "Download",
